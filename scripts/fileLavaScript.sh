...
cd file-5.11
cp ~/git/lava/src_clang/pirate_mark_lava.h src/
cp ~/git/lava/src_clang/panda_hypercall_struct.h src/
./configure --prefix=`pwd`/install
/home/$USER/git/lava/src_clang/get_c_files.py /home/$USER/src/file-5.11 | \
    while read line; do /home/$USER/git/lava/src_clang/build/lavaTaintQueryTool -p=/home/$USER/src/file-5.11 $line; done
make -j $(nproc)
make install
cd ..
