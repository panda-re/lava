        ...
        if (LavaAction == LavaQueries) {
...
#endif
            {
                ...
                top << ""
                    ...
                    << "((lava_tempval=(lava_extra[slot]>>16),__builtin_popcount(*(int*)&lava_tempval)>11) && (lava_tempval=(lava_extra[slot]>>16),lava_tempval=(__builtin_powif(lava_tempval,7)),(*(int*)&lava_tempval)&1))\n"
                    //<< "__attribute__((visibility(\"default\")))\n"
                    ...
                    << "((lava_tempval=(lava_extra[slot]>>16),__builtin_ffs(*(int*)&lava_tempval)>15) && (lava_tempval=(lava_extra[slot]>>16),__builtin_popcount(*(int*)&lava_tempval)>11))\n"
                    //<< "__attribute__((visibility(\"default\")))\n"
                    ...
                    << "((lava_tempval=(lava_extra[slot]>>16),__builtin_ffs(*(int*)&lava_tempval)>15) && (lava_tempval=((lava_extra[slot]>>16)^0x5555),__builtin_clz(*(int*)&lava_tempval)))\n"
                    ...
                    << "((lava_tempval=(lava_extra[slot]>>16),lava_tempval=__builtin_powif(lava_tempval,__builtin_ctz(*(int*)&lava_tempval)),__builtin_parity(*(int*)&lava_tempval)) && (lava_tempval=(lava_extra[slot]>>16),lava_tempval*=1337,(*(int*)&lava_tempval)&0xf0==0xf0))\n"
                    ...
                    << "((lava_tempval=(lava_extra[slot]>>16),lava_tempval+=0xdeadbeef,(*(int*)&lava_tempval)%10>5) && (lava_tempval=(lava_extra[slot]>>16),lava_tempval*=1337,(*(int*)&lava_tempval)&0xf0==0xf0))\n"
                    ...
                    << "((lava_tempval=(lava_extra[slot]>>16)^0x5555,lava_tempval=(__builtin_powif(lava_tempval,__builtin_popcount(*(int*)&lava_tempval)%7)),(__builtin_popcount(*(int*)&lava_tempval)&0xf)==7) && (lava_tempval=(lava_extra[slot]>>16),lava_tempval/=0xbeefdead,(*(int*)&lava_tempval)>5))\n"
