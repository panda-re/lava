...
=======
Yield varies considerably from 9.6\% to over 50\%.
>>>>>>> Fix some typos.
...
If we extrapolate from yield numbers in Table~\ref{table:insertion-results}, we estimate there would be over 400,000 real bugs if all were tested.
...
On the other hand, \verb+readelf+ and \verb+tshark+ fare worse, with only 2 and 122 source files found to involve a potential bug for each (16.7\% and 8.2\% of source files).
