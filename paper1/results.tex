...
We chose an open source fuzzer, two Commericial Static Analyzers (CSEs), and a Symbolic Execution and SAT Solver (SES) because they represented three unique approaches to vulnerability discovery.
