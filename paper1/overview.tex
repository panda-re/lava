...
Figures~\ref{fig:liv-graph} and~\ref{fig:tcn-graph} are plots of liveness and taint computer number for the program \verb+file+ processing the input \verb+/bin/ls+.
