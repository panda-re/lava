...
The \underline{T}aint \underline{C}ompute \underline{N}umber is a measure of how complicated a function of input bytes a tainted internal program quantity is.
...
All that is required is that it must be possible to inject a bug at the attack point by making use of dead data made available somehow.
Obviously, this means that the attack point must be \emph{temporally after} a DUA in the trace.
