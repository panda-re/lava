...
%opening
\title{LAVA: Lincoln Application Vulnerability Assessment
...
\author{
\IEEEauthorblockN{Brendan Dolan-Gavitt\IEEEauthorrefmark{1}, Patrick Hulin\IEEEauthorrefmark{2}, Tim Leek\IEEEauthorrefmark{2}, Ryan Whelan\IEEEauthorrefmark{2}, Fredrich Ulrich\IEEEauthorrefmark{2}}
\\
...
Every LAVA vulnerability is accompanied by a input that triggers it, whereas normal inputs are extremely unlikely to do so.
...
Using LAVA, we have injected tens of thousands of bugs into popular programs such as file, readelf, bash, tshark, and eog.
