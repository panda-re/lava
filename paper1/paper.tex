...
This lack of ground truth prevents authors and users of such tools from answering fundamental questions such as what the false positive and negative rates for a given tool are.
...
Every LAVA bug is accompanied by an input that triggers it and a guarantee that normal inputs are extremely unlikely to do so.
...
Our work forms the basis of an approach for generating large ground-truth vulnerability corpora on demand, enabling rigorous tool evaluation and giving tool vendors a high-quality target to aim for.
