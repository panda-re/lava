...
%opening
\title{LAVA: Lincoln Application Vulnerability Automation
...
Using LAVA, we have injected thousands of bugs into popular programs such as file, readelf, bash, tshark, and eog.
