...
\author{
\IEEEauthorblockN{Brendan Dolan-Gavitt\IEEEauthorrefmark{1}, Patrick Hulin\IEEEauthorrefmark{2}, Tim Leek\IEEEauthorrefmark{2}, Fredrich Ulrich\IEEEauthorrefmark{2}, Ryan Whelan\IEEEauthorrefmark{2}}
\\
...
LAVA employs a pair of taint-based measures to identify program quantities that
both depend upon specific input bytes in a simple way, yet do not overly influence control flow.
