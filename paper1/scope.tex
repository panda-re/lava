...
Most automated vulnerability discovery systems work with source code, 
%[References?],
 and we can easily test binary analysis tools by simply compiling the modified source.
